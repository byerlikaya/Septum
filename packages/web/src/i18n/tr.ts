export const trMessages: Record<string, string> = {
  ...
  "sidebar.changePassword": "Şifreyi değiştir",
  "sidebar.updateAvailable": "mevcut",

  "auth.login.title": "Giriş Yap",
  "auth.login.subtitle": "Septum hesabınıza giriş yapın",
  "auth.login.email": "E-posta",
  "auth.login.password": "Şifre",
  "auth.login.button": "Giriş Yap",
  "auth.login.error": "Geçersiz e-posta veya şifre.",

  "auth.changePassword.title": "Şifreyi değiştir",
  "auth.changePassword.subtitle": "Mevcut şifrenizi girin ve yeni bir şifre seçin.",
  "auth.changePassword.current": "Mevcut şifre",
  "auth.changePassword.new": "Yeni şifre",
  "auth.changePassword.confirm": "Yeni şifre (tekrar)",
  "auth.changePassword.submit": "Şifreyi güncelle",
  "auth.changePassword.cancel": "İptal",
  "auth.changePassword.success": "Şifre güncellendi.",
  "auth.changePassword.mismatch": "Şifreler eşleşmiyor.",
  "auth.changePassword.tooShort": "Şifre en az {min} karakter olmalı.",
  "auth.changePassword.wrongCurrent": "Mevcut şifre hatalı.",
  "auth.changePassword.error": "Şifre değiştirilemedi.",

  "users.title": "Kullanıcılar",
  "users.subtitle": "Hesap oluşturun, rol atayın ve Septum erişimini yönetin.",
  "users.loading": "Kullanıcılar yükleniyor…",
  "users.empty": "Henüz kullanıcı yok.",
  "users.createButton": "Kullanıcı ekle",
  "users.refresh": "Yenile",
  "users.column.email": "E-posta",
  "users.column.role": "Rol",
  "users.column.status": "Durum",
  "users.column.created": "Oluşturulma",
  "users.column.actions": "İşlemler",
  "users.status.active": "Aktif",
  "users.status.disabled": "Pasif",
  "users.role.admin": "Yönetici",
  "users.role.editor": "Editör",
  "users.role.viewer": "İzleyici",
  "users.action.edit": "Düzenle",
  "users.action.resetPassword": "Şifreyi sıfırla",
  "users.action.activate": "Aktifleştir",
  "users.action.deactivate": "Pasifleştir",
  "users.action.delete": "Sil",
  "users.confirm.delete": "Bu kullanıcıyı silmek istediğinize emin misiniz? Bu işlem geri alınamaz.",
  "users.confirm.deactivate": "Bu kullanıcı pasifleştirilecek ve artık giriş yapamayacak. Devam edilsin mi?",
  "users.error.generic": "İşlem başarısız.",
  "users.error.loadFailed": "Kullanıcılar yüklenemedi.",

  "users.form.createTitle": "Kullanıcı ekle",
  "users.form.editTitle": "Kullanıcıyı düzenle",
  "users.form.email": "E-posta",
  "users.form.password": "Şifre",
  "users.form.passwordHint": "En az {min} karakter.",
  "users.form.role": "Rol",
  "users.form.active": "Aktif",
  "users.form.save": "Kaydet",
  "users.form.cancel": "İptal",
  "users.form.saving": "Kaydediliyor…",
  "users.form.error.duplicateEmail": "Bu e-posta zaten kayıtlı.",

  "users.reset.title": "Şifreyi sıfırla",
  "users.reset.subtitle": "{email} için yeni bir şifre belirleyin.",
  "users.reset.newPassword": "Yeni şifre",
  "users.reset.confirm": "Yeni şifre (tekrar)",
  "users.reset.submit": "Şifreyi sıfırla",
  "users.reset.cancel": "İptal",
  "users.reset.success": "Şifre sıfırlandı.",
  ...
  "documents.preview.unlinkedEventHint": "Bu denetim olayı, varlık-seviyesi köken bağlantısından önce kaydedildi. Hangi varlıkların kapsandığını görmek için dokümanı yeniden işleyin.",
  "documents.preview.fromAuditEvent": "Bu olayda {count} varlık",
  ...
  "audit.filter.allEntityTypes": "Tüm varlık tipleri",
  "audit.filter.entityTypeHint": "Yalnızca bu varlık tipini içeren bağlantılı tespitlere sahip olayları gösterir",
  ...
  "setup.step.regulations.selectAll": "Tümünü seç",
  "setup.step.regulations.deselectAll": "Tümünü kaldır",
  "setup.step.regulations.selectedCount": "{selected} / {total} seçili",
