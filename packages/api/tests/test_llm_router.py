...
from septum_api.services import ollama_client
from septum_api.services.llm_router import LLMRouter
from factories.app_settings_factory import make_app_settings
...
async def test_llm_router_anthropic_complete(monkeypatch: pytest.MonkeyPatch, app_settings_anthropic: AppSettings) -> None:
    ...
    from septum_api.services.llm_providers import http_client as http_client_module
