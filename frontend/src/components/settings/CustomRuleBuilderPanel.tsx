...
import type { CustomRecognizer, DetectionMethod } from "@/lib/types";
...
export type CustomRuleBuilderPanelProps = {
  open: boolean;
  ...
  const buildCreatePayload = (
    ...
    const keywords =
      detectionMethod === "keyword_list"
        ? parseCommaSeparated(form.keywordsText)
        : undefined;
    const contextWords = parseCommaSeparated(form.contextWordsText);
