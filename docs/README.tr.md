...
Derinlemesine referans materyali. Proje genel bakışı için [ana README](../README.tr.md) dosyasına bakın.

## Sayfalar

| | Sayfa | Neyi kapsar |
|---|---|---|
| 🚀 | [Kurulum](INSTALLATION.tr.md) | Hızlı başlangıç, desteklenen beş topoloji, ilk açılış sihirbazı, LLM sağlayıcıları, güncelleme, sorun giderme |
