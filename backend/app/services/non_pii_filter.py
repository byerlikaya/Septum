...
code; all behavior is driven by database configuration.
"""
...
class NonPiiFilter:
    ...
    The filter uses a set of compiled rules derived from :class:`NonPiiRule`
    ...
    def __init__(self, rules: Iterable[NonPiiRule]) -> None:
    ...
    @classmethod
    def from_rules(cls, rules: Iterable[NonPiiRule]) -> "NonPiiFilter | None":
