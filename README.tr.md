...
- ✨ **[Özellikler](docs/FEATURES.tr.md)** — tespit benchmark'ı, regülasyon paketleri, MCP detayları, REST API + auth, neden-Septum karşılaştırması
- 📸 **[Ekran Görüntüleri](docs/SCREENSHOTS.tr.md)** — her ekranın görsel turu
- 🏗️ **[Mimari](docs/ARCHITECTURE.tr.md)** — modül kontratları, bölge kuralları, deployment topolojileri, API referansı
- 📊 **[Doküman İşleme](docs/DOCUMENT_INGESTION.tr.md)** — yükleme → tespit → maskeleme → indeksleme, adım adım
- 🤝 **[Katkı](CONTRIBUTING.tr.md)** — hata bildirimi, test çalıştırma ve pull request açma rehberi
