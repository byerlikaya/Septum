...
- **Audit Trail v2** — doküman önizlemesinde görsel vurgu ile entity konum takibi ve tekil denetim olayları için magnifying glass UX.
...
- **MCP SSE transport** — mevcut MCP sunucusu yalnızca stdio; SSE desteği tarayıcı + uzak istemci senaryolarını açar.
